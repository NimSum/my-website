...
const Contact = () => {
	...
	const decodeEmail = () => {
		...
		const key =
			"lLCvh2fqQW9po5b10HUOBjdi6DNyRXtkY8ZwEM4TaJPVFSm7sIcA3guKxGezrn";
		...
		<section className="contact-section" id="contact">
			<article>
				<div className="contact-intro">
					...
					<p>
						I am searching for an entry level Software Engineering position in
						Dallas. If you are interested, please send me a message! I will get
						back with you as soon as I can!{" "}
					</p>
				</div>
				<div className="icon-container">
					<a
						href="https://github.com/NimSum"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/nimrod-garcia/"
						target="_blank"
						rel="noopener noreferrer"
						title="LinkedIn"
					>
			...
			<footer>
				<p className="copy-right">
					Copyright &copy; {currDate.getFullYear()} Nimsum
				</p>
				<section className="site-info">
					<div>
						...
						<img
							...
							alt="sass"
							title="AWS S3, Cloudfront, Route53"
						/>
					</div>
					<a
						href="https://github.com/NimSum/my-website"
						title="Source"
						target="_blank"
						rel="noopener noreferrer"
					>
